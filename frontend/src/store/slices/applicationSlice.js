...
// Fetch all applications for employers
...
// Fetch all applications for job seekers
...
export const deleteApplication = (id) => async (dispatch) => {
  ...
  try {
    ...
    console.error("Delete Application Error:", error.response || error.message);
    dispatch(
